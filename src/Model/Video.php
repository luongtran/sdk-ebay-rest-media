...
class Video implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets expirationDate
     *
     * @param string|null $expirationDate The expiration date of the video in Coordinated Universal Time (UTC). The video’s expiration date is automatically set to 365 days (one year) after the video’s initial upload.
     *
     * @return self
     */
